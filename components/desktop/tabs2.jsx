...
export function Tabs2() {
  ...
  return (
    <>
      <div className="fixed top-0 z-10 flex w-full flex-shrink-0 flex-col items-center gap-4 bg-[#F4F4F4] p-2 px-3">
        <svg
        ...
        >
          <path
            d="M0.113647 7.22974H11.739C16.1227 7.22974 18.5741 9.89999 18.5741 14.6839V26.8596H0.113647V7.22974ZM13.6713 22.7635V14.759C13.6713 12.489 12.6082 11.3195 10.5633 11.3195H5.01016V22.7635H13.6713Z"
            fill="#F8BD03"
          />
          <path d="M21.8634 11.3197H19.6309V7.22363H26.7974V19.9808H21.8634V11.3197Z" fill="#F8BD03" />
          <path
            d="M42.3 11.3197H28.8111V7.22363H47.4904V11.2071L41.9685 26.8535H36.8531L42.3 11.3197ZM28.9612 16.729H33.8577V31.5686H28.9612V16.729Z"
            fill="#F8BD03"
          />
          ...
          />
          <path
            d="M104.379 27.0409V22.9448C104.892 23.0887 105.623 23.1262 106.242 23.1262C109.607 23.1262 111.289 21.0813 111.289 17.0603C111.289 13.1831 109.719 10.9568 107.011 10.9568C105.004 10.9568 103.61 12.1638 102.734 14.6464C102.077 16.216 101.677 18.4486 101.089 23.2763L100.652 27.0784H95.7926C96.049 23.8266 96.7807 18.4486 97.6187 13.9898L93.9291 7.22972H99.4885L101.133 10.1189C102.703 7.96139 104.86 6.90454 107.643 6.90454C112.977 6.90454 116.16 10.5629 116.16 16.7351C116.16 23.3888 112.652 27.2973 106.655 27.2973C105.736 27.2973 105.035 27.2223 104.379 27.0409Z"
            fill="#F8BD03"
          />
          <path
            d="M127.41 11.3196H117.392V0.682373H122.22V7.22356H132.638V11.0632L126.604 26.8534H121.451L127.41 11.3196Z"
            fill="black"
          />
          <path d="M136.734 11.3197H134.502V7.22363H141.706V26.8535H136.734V11.3197Z" fill="black" />
          <path
            d="M150.63 11.3197H143.613V7.22363H151.874C156.258 7.22363 158.672 9.85637 158.672 14.6778V26.8535H153.775V14.7591C153.769 12.4891 152.712 11.3197 150.63 11.3197Z"
            fill="black"
          />
          <path
            d="M160.804 17.5732V7.22986H165.701V17.2855C165.701 20.9751 167.383 23.2076 170.16 23.2076C173.155 23.2076 175.131 20.7562 175.131 17.0291C175.131 14.3964 175.094 13.152 174.512 12.314C173.999 11.5073 173.124 11.1446 171.804 11.1446C171.073 11.1446 170.084 11.3259 169.134 11.6574V7.78017C170.378 7.34242 171.986 7.01099 173.518 7.01099C175.531 7.01099 177.501 7.5613 178.633 9.28102C179.84 10.9632 180.021 13.2645 180.021 16.704C180.021 23.0638 175.963 27.3787 169.966 27.3787C164.312 27.3725 160.804 23.6016 160.804 17.5732Z"
            fill="black"
          />
          <path
            d="M181.091 22.87H183.648C185.256 22.87 186.062 21.9945 186.062 20.3498V11.3197H181.566V7.22363H190.959V20.5999C190.959 24.696 188.726 26.9222 184.78 26.9222H181.091V22.87Z"
            fill="black"
          />
          <path d="M195.355 11.3197H193.122V7.22363H200.327V26.8535H195.355V11.3197Z" fill="black" />
          <path
            d="M215.935 11.3197H202.447V7.22363H221.126V11.2071L215.604 26.8535H210.489L215.935 11.3197ZM202.59 16.729H207.487V31.5686H202.59V16.729Z"
            fill="black"
          />
          <path
            d="M248.985 7.22974H225.297C224.246 7.22974 223.396 8.08022 223.396 9.13081V24.971C223.396 26.0216 224.246 26.8721 225.297 26.8783H248.985C250.036 26.8783 250.893 26.0278 250.893 24.971V9.16833C250.911 8.11774 250.08 7.2485 249.029 7.22974H248.985ZM239.786 20.4247L236.572 23.6578H227.373C227.004 23.6703 226.698 23.3826 226.685 23.0136V16.116C226.673 15.7345 226.973 15.4219 227.354 15.4156H239.161C239.542 15.4156 239.849 15.722 239.849 16.1035V16.1223L239.786 20.4247ZM239.105 15.9472H227.298C227.211 15.9534 227.135 16.0284 227.129 16.116V22.9886C227.129 23.0824 227.204 23.1575 227.298 23.1575H236.284L239.274 20.187V16.0972C239.267 16.0159 239.192 15.9534 239.105 15.9472ZM229.85 21.2064C229.868 21.6754 229.506 22.0756 229.037 22.0944C229.012 22.0944 228.987 22.0944 228.955 22.0944C228.474 22.0944 228.08 21.7004 228.08 21.2189C228.092 20.7374 228.48 20.3559 228.955 20.3434C229.431 20.3559 229.812 20.7436 229.812 21.2189L229.85 21.2064ZM232.401 21.2064C232.413 21.6754 232.038 22.0694 231.569 22.0819C231.557 22.0819 231.544 22.0819 231.532 22.0819C231.050 22.0819 230.656 21.6941 230.656 21.2064C230.669 20.7248 231.056 20.3434 231.532 20.3309C232.007 20.3434 232.388 20.7311 232.388 21.2064H232.401ZM234.952 21.2064C234.965 21.6816 234.590 22.0694 234.114 22.0819C234.102 22.0819 234.089 22.0819 234.077 22.0819C233.595 22.0819 233.201 21.6941 233.201 21.2064C233.214 20.7248 233.595 20.3434 234.077 20.3309C234.552 20.3434 234.934 20.7311 234.934 21.2064H234.952ZM235.772 27.4912V32.2313C235.772 33.2569 235.215 33.4570 234.571 32.6878L230.018 27.4912H235.772Z"
            fill="#F8BD03"
          />
        </svg>
      </div>
      <div>
        ...
        <div className="fixed right-6 bottom-6 left-6 z-10 flex">
          {isCompleted ? (
            <div
              className="mx-auto flex h-[90px] w-full items-center justify-between rounded-[40px] bg-yellow-400 p-3 shadow-lg"
              dir="rtl"
            >
                ...
                {stepsData.map((step) => {
                  ...
                  return (
                    <button
                      ...
                      className="relative mx-1 flex h-[60px] w-[60px] flex-shrink-0 cursor-pointer items-center justify-center rounded-full bg-white"
                    >
                      <Icon className="h-8 w-8 text-black" />
                      {step.statusIcon && (
                        <span className="absolute -top-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-yellow-400 bg-black text-xs font-bold text-white">
                          {step.statusIcon}
                        </span>
                      )}
                    </button>
              ...
              <button
                onClick={submitForm}
                className="mr-1 flex items-center justify-center gap-3 rounded-full bg-white px-5 py-3 font-bold text-black"
              >
                <span>שלח</span>
            ...
            <div className="mx-auto flex w-full flex-col items-center justify-between rounded-[40px] bg-yellow-400 p-3 shadow-lg">
                      ...
                      >
                        {activeStep === step.id ? (
                          <div className="flex items-center gap-2">
                            <div className="flex h-[70px] w-[70px] flex-shrink-0 items-center justify-center rounded-full bg-black">
                              <Icon className="h-8 w-8 text-white" />
                            </div>
                            <div className="px-2 text-right text-black">
                              <div className="text-lg font-bold">{step.title}</div>
                              <div className="text-base">{step.subtitle}</div>
                            </div>
                          </div>
                        ) : (
                          <div className="flex h-[55px] w-[55px] flex-shrink-0 items-center justify-center rounded-full bg-white">
                            <Icon className="h-8 w-8 text-black" />
                          </div>
                        )}
                      </button>
                  ...
                  {brunches.map((brunch, index) => (
                    <div key={brunch.id} className="flex items-center gap-2">
                      <button
                        ...
                        className={`h-5 w-5 rounded-full border-2 border-white transition-all duration-200 ${activeBrunch === brunch.id ? 'w-[190px] border-white bg-white pb-6 shadow-md' : 'bg-white p-3'}`}
                      >
              ...
              {openedStep && (
                <p className="w-full bg-yellow-400 p-3 text-sm leading-relaxed font-medium text-black">
                  להצטרפות כמשווק רשמי בחברת 'יוסי תקשורת', יש למלא את פרטי העסק שלך. המידע יסייע לנו להעניק לך את הכלים
                  והמשאבים להצלחה מירבית.
                </p>
              )}
            </div>
          )}
        ...
        <div className="bg-opacity-20 border-opacity-30 fixed top-[calc(100vh-theme('spacing.6'))] right-0 left-0 z-5 h-10 border-t border-white bg-white backdrop-blur-md"></div>
      </div>
